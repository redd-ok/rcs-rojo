...
return function(Iris: Types.Internal, widgets: Types.WidgetUtility)
	...
	local function clearLine(thisWidget: Types.PlotLines)
		if thisWidget.HoveredLine then
			thisWidget.HoveredLine.BackgroundColor3 =
				Iris._config.PlotLinesColor
			thisWidget.HoveredLine.BackgroundTransparency =
				Iris._config.PlotLinesTransparency
	...
	local function updateLine(thisWidget: Types.PlotLines)
		...
		local scale: number = (mousePosition.X - position.X)
			/ Plot.AbsoluteSize.X
		...
		if line then
			...
			line.BackgroundTransparency =
				Iris._config.PlotLinesHoveredTransparency
	...
	local function clearBlock(thisWidget: Types.PlotHistogram)
		if thisWidget.HoveredBlock then
			thisWidget.HoveredBlock.BackgroundColor3 =
				Iris._config.PlotHistogramColor
			thisWidget.HoveredBlock.BackgroundTransparency =
				Iris._config.PlotHistogramTransparency
	...
	local function updateBlock(thisWidget: Types.PlotHistogram)
		...
		if block then
			...
			block.BackgroundTransparency =
				Iris._config.PlotHistogramHoveredTransparency
